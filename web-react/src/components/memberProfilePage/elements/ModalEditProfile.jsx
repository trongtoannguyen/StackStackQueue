      ...
      <Modal.Body>
        <Row>
          <div className="form-group mb-3 col-md-6">
            ...
            <small className={!validName ? "text-danger" : ""} role="alert" hidden={validName}>
              <i className="fa fa-info-circle" aria-hidden="true"></i>{" "}Name is not empty
            </small>
          </div>
          <div className="form-group mb-3 col-md-6">
        ...
        <Row>
          <div className="form-group mb-3 col-md-6">
            <label className="form-label" htmlFor="title">Email<span className='text-danger'>(*)</span></label>
            <input className="form-control" id="email"
              type="email"
              value={email}
              onChange={(event) => setEmail(event.target.value)}
              placeholder="Enter new email" />
            <small className={!validEmail ? "text-danger" : ""} role="alert" hidden={validEmail}>
              <i className="fa fa-info-circle" aria-hidden="true"></i>{" "}Please enter a valid email address
            </small>
          </div>
          <div className="form-group mb-3 col-md-6">
            <label className="form-label" htmlFor="title">Phone number<span className='text-danger'>(*)</span></label>
        ...
        <Row>
          <div className="form-group mb-3 col-md-6">
            <label className="form-label" htmlFor="title">Address<span className='text-danger'>(*)</span></label>
            <input className="form-control" id="name"
              type="text"
              value={address}
              onChange={(event) => setAddress(event.target.value)}
              placeholder="Enter new address" />
            <small className={!validAddress ? "text-danger" : ""} role="alert" hidden={validAddress}>
              <i className="fa fa-info-circle" aria-hidden="true"></i>{" "}Address is not empty
            </small>
          </div>
          <div className="form-group mb-3 col-md-6">
            <label className="form-label" htmlFor="title">Birthday<span className='text-danger'>(*)</span></label>
            <input className="form-control" id="name"
              type="date"
              onChange={(event) => setBirthDate(event.target.value)}
              value={birthDate}
              placeholder="Enter new address" />
            <small className={!validBirth ? "text-danger" : ""} role="alert" hidden={validBirth}>
              <i className="fa fa-info-circle" aria-hidden="true"></i>{" "} The day of birth must be from 16 to 100 years old.
            </small>
          </div>
        </Row>
        <div className="form-group mb-3">
          <label className="form-label" htmlFor="title">Bio:</label>
          <textarea cols={12}
