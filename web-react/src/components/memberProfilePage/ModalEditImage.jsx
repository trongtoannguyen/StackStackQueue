    ...
    <Modal show={show} onHide={handleCloseModal}
      ...
      <Modal.Body>
        <Col className="d-flex justify-content-center mb-3">
          <div className="">
            <img src={img ?? getAvatar()} alt="avatar" id="ava"
              style={{
                height: `300px`,
                width: `300px`,
                objectFit: `cover`,
        ...
        <Col className="text-center mb-3">
          <label htmlFor="file">Choose new file
          </label>
          <input type="file" name="file" className="d-none"
            id="file"
      ...
      <Modal.Footer>
        <Button variant="secondary" onClick={handleCloseModal} className='ml-0 me-auto'>
          Close
        </Button>
        <Button variant="primary" onClick={handleUpload} className='ml-auto me-0'>
          Save change
        </Button>
      </Modal.Footer>
