  ...
  return (
    <Modal show={show} onHide={handleClose}
      ...
      <Modal.Header closeButton>
        <Modal.Title className='text-danger'><i className="fa-solid fa-triangle-exclamation"></i> Delete user {user?.username}</Modal.Title>
      </Modal.Header>
      ...
      <Modal.Footer>
        ...
        <Button variant="danger" onClick={handleConfirmDeleteUser} className='ml-auto me-0'>
          Delete User
        </Button>
      </Modal.Footer>
